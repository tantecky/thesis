...
\usepackage[top=2.5cm, bottom=2.5cm, left=3.5cm, right=2cm]{geometry} %nastaveni okraju a vzdalenosti cislovani
...
\usepackage{float} %pro vlastní float objekty
\usepackage{pdfpages} %pro vkladani pdfek
%pro zdrojaky
\usepackage{listingsutf8}

%novy float objekt grf
\floatstyle{plain}
\newfloat{grf}{thp}{lop}[chapter]
\floatname{grf}{Graf}
\newsubfloat{grf} %i pro subfloat
...
\begin{document}
	...
	\include{title}
	\includepdf{images/Title-1-edit.PDF}
	\includepdf{images/Title-2-edit.PDF}
