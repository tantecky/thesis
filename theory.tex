...
\begin{equation}
	...
	\label{eq:conti2}
\end{equation} 
kde člen $\Gamma_{ij}$ představuje hmotnostní tok mezi $i$-tou a $j$-tou fází vztažený na objemový element a $\alpha_{i}$ značí objemový zlomek dané fáze. Pokud však nedochází k transportu hmoty mezi fázemi, tak pravá strana rov. \ref{eq:conti2} je rovna nule. Objemové zlomky všech fází navíc musí splňovat algebraickou rovnici \ref{eq:volfrac}.
\begin{equation}
