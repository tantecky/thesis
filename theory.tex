...
\begin{enumerate}[itemsep=0pt,parsep=0pt,partopsep=0pt,topsep=0pt,label=\bfseries\arabic*{.}]
  ...
  \item \textbf{Vlastní výpočet}
  \item \textbf{Analýza výsledků (postprocessing)}
\end{enumerate}
