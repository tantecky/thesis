...
\begin{figure}[h!]
 \centering
  \subfloat[v~čase \SI{2}{\second}]{\label{fig:h-w10-5s-num}\includegraphics[scale=0.36]{Results/CloudHeight/w10-5s.eps}} 
  \qquad 
  \subfloat[v~čase \SI{7}{\second}]{\label{fig:h-w10-5s-exp}\includegraphics[scale=0.34]{Results/CloudHeight/pvp7-vol10-5s.eps}}
  \caption{Průběh objemového zlomku pevné fáze}
  \label{fig:h-w10-5s}
\end{figure}
...
\begin{figure}[h!]
 \centering
  \subfloat[v~čase \SI{2}{\second}]{\label{fig:h-w10-6s-num}\includegraphics[scale=0.36]{Results/CloudHeight/w10-6s.eps}} 
  \qquad 
  \subfloat[v~čase \SI{7}{\second}]{\label{fig:h-w10-6s-exp}\includegraphics[scale=0.305]{Results/CloudHeight/pvp7-vol10-6s.eps}}
  \caption{Průběh objemového zlomku pevné fáze}
  \label{fig:h-w10-6s}
\end{figure}
