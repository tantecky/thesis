...
Kromě modelu Eulerian-Eulerian byl také využit pro srovnání přístup Eulerian-Granular pro popis vícefázového proudění v~mechanicky míchané nádobě. Za účelem srovnání těchto technik byly provedeny dvě sady simulací s~rozdílnou koncentrací kuliček z~PVC (5 a \volproc{15}).
...
\begin{figure}[h!]
 \centering
  ...
  \caption{Distribuce PVC koncentraci \volproc{5}, $N=\SI{3}{\per\second}$}
  \label{fig:w5}
\end{figure}
...
\begin{figure}[h!]
 \centering
  ...
  \caption{Distribuce PVC koncentraci \volproc{15}, $N=\SI{5}{\per\second}$}
  \label{fig:w15}
\end{figure}
