...
\begin{figure}[h!]
 \centering
  \subfloat[simulace]{\label{fig:EE-w5}\includegraphics[scale=0.36]{Results/EEvsEGM/EE-w5-3s.eps}} 
  \qquad 
  \subfloat[experiment]{\label{fig:EGM-w5}\includegraphics[scale=0.36]{Results/EEvsEGM/EGM-w5-3s.eps}}
  \\
...
\begin{figure}[h!]
 \centering
  \subfloat[simulace]{\label{fig:EE-w15}\includegraphics[scale=0.36]{Results/EEvsEGM/EE-w15-5s.eps}} 
  \qquad 
  \subfloat[experiment]{\label{fig:EGM-w15}\includegraphics[scale=0.36]{Results/EEvsEGM/EGM-w15-5s.eps}}
  \\
  \subfloat[experiment]{\label{fig:EGM-w15}\includegraphics[scale=0.34]{Results/EEvsEGM/PVP7-w15-5s.eps}}
  \caption{hhh}
  \label{fig:w15}
\end{figure}
