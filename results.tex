...
\begin{grf}[h!]
 \centering
  \includegraphics[scale=0.42]{Results/Velocity/velField.eps}
...
\begin{figure}[h!]
 \centering
  ...
  \subfloat[Schiller-Naumann]{\label{fig:neu2}\includegraphics[scale=0.36]{Results/CDComp/neu-2s.eps}}  
  \qquad             
  \subfloat[{Brucato}]{\label{fig:bru2}\includegraphics[scale=0.336]{Results/CDComp/bru-2s.eps}}
%\end{figure}
%\newpage
%\begin{figure}[t!]
	%\centering{}
  %\addtocounter{subfigure}{2}
  \\
  \subfloat[{Pinelli}]{\label{fig:pin2}\includegraphics[scale=0.36]{Results/CDComp/pin-2s.eps}}
  \qquad
  \subfloat[{Khopkar}]{\label{fig:kho2}\includegraphics[scale=0.36]{Results/CDComp/kho-2s.eps}}
...
\begin{figure}[h!]
 \centering
  \subfloat[model Eulerian-Eulerian]{\label{fig:EE-w5}\includegraphics[scale=0.35]{Results/EEvsEGM/EE-w5-3s.eps}} 
  \qquad 
  \subfloat[model Eulerian-Granular]{\label{fig:EGM-w5}\includegraphics[scale=0.35]{Results/EEvsEGM/EGM-w5-3s.eps}}
  \\
  \subfloat[experiment]{\label{fig:exp-w5}\includegraphics[scale=0.33]{Results/EEvsEGM/PVP7-w5-3s.eps}}
...
\begin{figure}[h!]
 \centering
  \subfloat[model Eulerian-Eulerian]{\label{fig:EE-w15}\includegraphics[scale=0.35]{Results/EEvsEGM/EE-w15-5s.eps}} 
  \qquad 
  \subfloat[model Eulerian-Granular]{\label{fig:EGM-w15}\includegraphics[scale=0.35]{Results/EEvsEGM/EGM-w15-5s.eps}}
  \\
...
\begin{figure}[h!]
 \centering
  ...
  \subfloat[$t=\SI{0}{\second}$]{\label{fig:t0}\includegraphics[scale=0.36]{Results/MixingTime/voda-6s/t0.eps}}  
  \qquad             
  \subfloat[{$t=\SI{2}{\second}$}]{\label{fig:t2}\includegraphics[scale=0.36]{Results/MixingTime/voda-6s/t2.eps}}
  \\
  \subfloat[{$t=\SI{5}{\second}$}]{\label{fig:t5}\includegraphics[scale=0.36]{Results/MixingTime/voda-6s/t5.eps}}
  \qquad
  \subfloat[{$t=\SI{7}{\second}$}]{\label{fig:t7}\includegraphics[scale=0.36]{Results/MixingTime/voda-6s/t7.eps}}
...
\begin{grf}[t!]
  ...
  \centering
  \subfloat[\volproc{15} PVC]{\label{fig:homvoda-w15}\includegraphics[scale=0.435]{Results/MixingTime/voda-6s/15/grafy.eps}} 
...
\begin{grf}[h!]
 \centering 
  \includegraphics[scale=0.435]{Results/MixingTime/PVP5-7s/5/grafy.eps}
